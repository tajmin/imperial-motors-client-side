        ...
        <div>
            ...
            <div className="container max-w-md xl:max-w-xl mx-auto">
                ...
                <form onSubmit={handleSubmit(handleForm)}>
                    <div className="py-4">
                        <textarea rows="10" {...register("reviewText", { required: true })} placeholder="Give your feedback" className="w-full py-2 px-2 border-none rounded" type="text" name="reviewText" />
                        {errors.reviewText && <span className="text-red-700">This field is required</span>}
                    </div>
