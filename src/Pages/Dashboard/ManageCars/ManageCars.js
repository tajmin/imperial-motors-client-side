        ...
        <div>
            ...
            <div className="overflow-x-auto">
                <table className="table w-full">
                    ...
                    <tbody>
                        {
                            cars.map((item, index) => <tr key={item._id}>
                                <th>
                                    {index + 1}
                                </th>
                                <td>
                                ...
                                <th>
                                    <button onClick={() => handleDeletion(item._id)} className="bg-red-700 hover:bg-red-800 px-4 py-2 rounded text-white m-auto">Delete</button>
                                </th>
                            </tr>)
                        }
                    </tbody>
