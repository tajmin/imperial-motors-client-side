...
const Car = ({ car }) => {
    ...
    return (
        <div style={bgStyle} className="z-0 flex relative">
            <div className="text-left bg-gray-900 opacity-80 absolute bottom-0 left-0 xl:top-0 xl:block xl:h-full py-4 px-6 xl:py-10 xl:px-12 xl:my-auto xl:max-w-xl z-20">
                <h1 className="text-xl xl:text-5xl text-red-600 font-bold font-serif xl:py-10">{title}</h1>
